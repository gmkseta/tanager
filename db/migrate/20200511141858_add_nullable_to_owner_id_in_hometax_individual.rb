class AddNullableToOwnerIdInHometaxIndividual < ActiveRecord::Migration[5.2]
  ...
  def change
    ...
    add_index :hometax_individual_incomes, [:owner_id, :declare_year],
      name: "index_hometax_individual_incomes_on_declare_user_id_and_year", unique: true, algorithm: :concurrently
  end
end
